...
public class CLI {
  ...
  @Option(name = "-annealingPolicy", usage = "Set annealing policy, default 0")
  private Integer ANNEALING = 0;

  @Option(name = "-withRestart", usage = "Set restart policy, default false")
  ...
  public Config parseArgs(String[] args) throws FileNotFoundException {
    ...
    return new Config().setRandNeighborsSampleSize(randNeighborsSampleSize)
            .setAnnealPolicy(ANNEALING)
            .setRestartPolicy(RESTART)
            .setDelta(DELTA)
