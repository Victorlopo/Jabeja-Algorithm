...
public class Config {
  private Integer annealingPolicy;
  private Boolean restartPolicy;
  ...
  public Config setAnnealPolicy(Integer annealingPolicy){
    this.annealingPolicy = annealingPolicy;
    return this; 
  }

  public Config setRestartPolicy(Boolean restartPolicy){
  ...
  public Integer getAnnealingPolicy(){
    if (annealingPolicy == null){
      throw new NullPointerException("No annealing policy defined");
    }
